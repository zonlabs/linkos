                ...
                <div className="grid gap-6">
                    <form onSubmit={handleSignup}>
                        <div className="grid gap-4">
                            ...
                            <Button type="button" variant="outline" className="w-full bg-white/5 border-white/10 text-white hover:bg-white hover:text-black h-11 transition-all font-bold mb-4" onClick={() => supabase.auth.signInWithOAuth({ provider: 'google', options: { redirectTo: `${window.location.origin}/auth/callback` } })}>
